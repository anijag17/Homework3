...
public class IInstructorTest {
	  private IInstructor instructor;
	    ...
	    public void InstructorAssigned1(){
	        ...
	        String InstructorName = this.admin.getClassInstructor("Test", 2017);
	    ...
	    public void InstructorAssigned2(){
	        ...
	        this.student.registerForClass("Student", "Test", 2017);
	        String InstructorName = this.admin.getClassInstructor("Test", 2017);
	        assertFalse(InstructorName.contentEquals("Alok"));
	    }
	    ...
	    public void grade1(){
	        ...
	        int grade = this.instructor.getGrade("Test", 2017, "hw3", "Student");
